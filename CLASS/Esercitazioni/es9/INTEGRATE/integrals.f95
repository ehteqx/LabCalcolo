...
contains
	...
	FUNCTION fun(x) result(y)
		...
		real (kind = rk) :: y
		y = x**4	! Insert here the FUNCTION you want to integrate
	END FUNCTION fun
...
PROGRAM INTEGRALS
	...
	real (kind = rk) :: a, b, trapezio, simpsono
	integer (kind = ik) :: n
	
	! Cosmetics and user input
	print*, 'Benvenuto! Questo software integrera* la funzione x**4 .' ! Change function
	print*, 
	print*, 
